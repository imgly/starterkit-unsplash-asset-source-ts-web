...
```bash
git clone https://github.com/imgly/starterkit-unsplash-editor-ts-web.git
cd starterkit-unsplash-editor-ts-web
```
...
```
starterkit-unsplash-editor-ts-web/
├── src/
...
│       └── plugins/
│           └── unsplash.ts       # Unsplash asset source
├── package.json
└── vite.config.ts
```
