/**
 * Unsplash Editor Plugin - Design Editor with Unsplash Image Integration
 *
 * This plugin provides a production-ready design editor configuration with
 * Unsplash image library integration, templates, elements, and comprehensive
 * editing capabilities.
 *
 * @example Basic usage
 * ```typescript
 * import CreativeEditorSDK from '@cesdk/cesdk-js';
 * import { UnsplashEditorConfig } from './plugin';
 *
 * const cesdk = await CreativeEditorSDK.create('#editor', config);
 * await cesdk.addPlugin(new UnsplashEditorConfig());
...
/**
 * Unsplash Editor configuration plugin.
 *
 * Provides a complete design editing experience with Unsplash image library
 * integration, optimized for creating graphics, templates, marketing materials,
 * and multi-page documents with free high-quality images.
 *
 * @public
 */
export class UnsplashEditorConfig implements EditorPlugin {
  /**
   * Unique identifier for this plugin.
   * Used to identify the plugin in the CE.SDK plugin registry.
   */
  name = 'cesdk-unsplash-editor';
