...
import { UnsplashEditorConfig } from './config/plugin';
import {
...
export { UnsplashEditorConfig } from './config/plugin';
export {
  UnsplashAssetSourcePlugin,
  unsplashAssetSource,
...
export async function initUnsplashEditor(
  ...
  await cesdk.loadFromURL(
    'https://img.ly/showcases/cesdk/cases/unsplash-image-assets/unsplash.scene'
  );
}
